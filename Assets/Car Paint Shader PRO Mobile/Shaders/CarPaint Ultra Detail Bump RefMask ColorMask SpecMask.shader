...
void main ()
{
  ...
  tmpvar_11 = (_LightColor0.xyz * max (0.0, dot (tmpvar_5, lightDirection)));
  ...
  lowp vec4 tmpvar_26;
  tmpvar_26.w = 1.0;
  tmpvar_26.xyz = (((tmpvar_8.xyz * mix (_Color.xyz, vec3(1.0, 1.0, 1.0), vec3((1.0 - tmpvar_8.w)))) * clamp (((xlv_TEXCOORD2 + ambientLighting) + diffuseReflection), 0.0, 1.0)) + specularReflection);
...
void main ()
{
  ...
  highp vec3 tmpvar_12;
  tmpvar_12 = ((tmpvar_10.x * _LightColor0.xyz) * max (0.0, dot (tmpvar_5, lightDirection)));
  ...
  lowp vec4 tmpvar_28;
  tmpvar_28.w = 1.0;
  tmpvar_28.xyz = (((tmpvar_8.xyz * mix (_Color.xyz, vec3(1.0, 1.0, 1.0), vec3((1.0 - tmpvar_8.w)))) * clamp (((xlv_TEXCOORD2 + ambientLighting) + diffuseReflection), 0.0, 1.0)) + specularReflection);
...
Program "fp" {
// Fragment combos: 6
//   opengl - ALU: 105 to 108, TEX: 4 to 5
//   d3d9 - ALU: 105 to 107, TEX: 4 to 5
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
...
ADD R4.xyz, fragment.texcoord[2], c[0];
ADD_SAT R4.xyz, R4, R5;
...
def c17, 2.00000000, -1.00000000, 3.00000000, 1.00000000
...
mov_pp r3.xyz, c4
add_pp r4.xyz, v2, c0
add_pp_sat r4.xyz, r4, r5
add_pp r1.w, -r0, c17
add_pp r3.xyz, c17.w, -r3
mad_pp r3.xyz, r1.w, r3, c4
mul_pp r0.xyz, r0, r3
mad_pp r3.xyz, r0, r4, r6
dp3_pp r1.w, r2, v4
...
ADD R6.xyz, R3.w, -c[4];
ADD R1.w, -R0, c[16].x;
MAD R5.yzw, R1.w, R6.xxyz, c[4].xxyz;
ADD R6.xyz, fragment.texcoord[2], c[0];
DP3 R1.w, fragment.texcoord[4], fragment.texcoord[4];
ADD_SAT R2.xyz, R6, R2;
MUL R0.xyz, R0, R5.yzww;
MAD R0.xyz, R0, R2, R4;
...
dp3 r1.w, r1, r0
mad_pp r0.xyz, -r3, c16.x, -r0
mul r4.xyz, r0.w, r4
dp3_pp r0.x, r0, r4
cmp r0.y, r1.w, c18.x, c18
texldp r4.x, v7, s2
max_pp r3.x, r0, c16.z
abs_pp r2.w, r0.y
pow_pp r0, r3.x, c7.x
mov_pp r0.w, r0.x
...
mul_pp r2.w, r0, c8.x
add_pp r6.xyz, v2, c0
add_pp_sat r5.xyz, r6, r5
mov_pp r4.yzw, c4.xxyz
add_pp r6.xyz, c17.w, -r4.yzww
add_pp r1.w, -r0, c17
mad_pp r6.xyz, r1.w, r6, c4
mul_pp r0.xyz, r0, r6
