...
void main ()
{
  ...
  lowp vec3 tmpvar_7;
  tmpvar_7 = -(tmpvar_2);
  worldReflVec = tmpvar_7;
  lowp vec4 tmpvar_8;
  tmpvar_8 = textureCube (_Cube, worldReflVec);
  reflcol = tmpvar_8;
  lowp float tmpvar_9;
  tmpvar_9 = clamp ((1.0 - max (dot (normalize (tmpvar_3), normalize (-(xlv_TEXCOORD3))), 0.0)), 0.0, 1.0);
  mediump float tmpvar_10;
  tmpvar_10 = max ((0.20373 + ((1.0 - 0.20373) * pow (tmpvar_9, _FresnelPower))), 0.0);
  refl2Refr = tmpvar_10;
  mediump vec3 tmpvar_11;
  tmpvar_11 = ((((reflcol.xyz * _ReflectColor.xyz) * _TintColor.xyz) * (1.0 - (tex.w * (1.0 - _OpaqueReflection)))) + (tex * _Color).xyz);
  tmpvar_4 = tmpvar_11;
  mediump float tmpvar_12;
  tmpvar_12 = clamp ((refl2Refr * _AlphaPower), 0.0, 1.0);
  tmpvar_5 = tmpvar_12;
  lowp vec4 c_i0_i1;
...
void main ()
{
  ...
  c.xyz = (tmpvar_4 * ((8.0 * tmpvar_13.w) * tmpvar_13.xyz));
  c.w = tmpvar_5;
  c.xyz = (c.xyz + (tmpvar_4 * 0.25));
  c.w = tmpvar_5;
  gl_FragData[0] = c;
...
bfaaaaaaabaaahacadaaaaoeaeaaaaaaaaaaaaaaaaaaaaaa neg r1.xyz, v3
bfaaaaaaadaaahacadaaaaoeaeaaaaaaaaaaaaaaaaaaaaaa neg r3.xyz, v3
bcaaaaaaabaaabacabaaaakeacaaaaaaadaaaakeacaaaaaa dp3 r1.x, r1.xyzz, r3.xyzz
akaaaaaaabaaabacabaaaaaaacaaaaaaaaaaaaaaaaaaaaaa rsq r1.x, r1.x
bfaaaaaaaeaaahacadaaaaoeaeaaaaaaaaaaaaaaaaaaaaaa neg r4.xyz, v3
...
ciaaaaaaadaaapacaaaaaageacaaaaaaabaaaaaaafbababb tex r3, r0.xyzy, s1 <cube wrap linear point>
...
adaaaaaaabaaabacaeaaaappacaaaaaaabaaaaaaacaaaaaa mul r1.x, r4.w, r1.x
...
adaaaaaaaeaaahacadaaaakeacaaaaaaajaaaaaaabaaaaaa mul r4.xyz, r3.xyzz, c9.x
...
akaaaaaaabaaabacabaaaaaaacaaaaaaaaaaaaaaaaaaaaaa rsq r1.x, r1.x
bfaaaaaaafaaahacadaaaaoeaeaaaaaaaaaaaaaaaaaaaaaa neg r5.xyz, v3
...
ciaaaaaaaeaaapacaaaaaageacaaaaaaabaaaaaaafbababb tex r4, r0.xyzy, s1 <cube wrap linear point>
bcaaaaaaaaaaabacacaaaaoeaeaaaaaaacaaaaoeaeaaaaaa dp3 r0.x, v2, v2
akaaaaaaaaaaabacaaaaaaaaacaaaaaaaaaaaaaaaaaaaaaa rsq r0.x, r0.x
adaaaaaaaaaaahacaaaaaaaaacaaaaaaacaaaaoeaeaaaaaa mul r0.xyz, r0.x, v2
bcaaaaaaaaaaabacaaaaaakeacaaaaaaabaaaakeacaaaaaa dp3 r0.x, r0.xyzz, r1.xyzz
...
bfaaaaaaafaaaiacacaaaappacaaaaaaaaaaaaaaaaaaaaaa neg r5.w, r2.w
adaaaaaaaaaaabacafaaaappacaaaaaaaaaaaaaaacaaaaaa mul r0.x, r5.w, r0.x
abaaaaaaaaaaabacaaaaaaaaacaaaaaaagaaaappabaaaaaa add r0.x, r0.x, c6.w
...
void main ()
{
  ...
  tmpvar_14 = vec2(dot (xlv_TEXCOORD5, xlv_TEXCOORD5));
  lowp vec4 c_i0_i1;
  c_i0_i1.xyz = ((tmpvar_4 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD3, lightDir)) * texture2D (_LightTexture0, tmpvar_14).w) * 2.0));
  c_i0_i1.w = tmpvar_5;
  c = c_i0_i1;
  c.w = tmpvar_5;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  lowp float atten;
  atten = ((float((xlv_TEXCOORD5.z > 0.0)) * texture2D (_LightTexture0, ((xlv_TEXCOORD5.xy / xlv_TEXCOORD5.w) + 0.5)).w) * texture2D (_LightTextureB0, tmpvar_14).w);
  lowp vec4 c_i0_i1;
...
void main ()
{
  ...
  tmpvar_14 = vec2(dot (xlv_TEXCOORD5, xlv_TEXCOORD5));
  lowp vec4 c_i0_i1;
  c_i0_i1.xyz = ((tmpvar_4 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD3, lightDir)) * (texture2D (_LightTextureB0, tmpvar_14).w * textureCube (_LightTexture0, xlv_TEXCOORD5).w)) * 2.0));
  c_i0_i1.w = tmpvar_5;
  c = c_i0_i1;
  c.w = tmpvar_5;
  gl_FragData[0] = c;
...
ciaaaaaaadaaapacabaaaageacaaaaaaabaaaaaaafbababb tex r3, r1.xyzy, s1 <cube wrap linear point>
ciaaaaaaaaaaapacaaaaaafeacaaaaaaacaaaaaaafaababb tex r0, r0.xyyy, s2 <2d wrap linear point>
bfaaaaaaaeaaahacadaaaaoeaeaaaaaaaaaaaaaaaaaaaaaa neg r4.xyz, v3
bfaaaaaaafaaahacadaaaaoeaeaaaaaaaaaaaaaaaaaaaaaa neg r5.xyz, v3
bcaaaaaaabaaabacaeaaaakeacaaaaaaafaaaakeacaaaaaa dp3 r1.x, r4.xyzz, r5.xyzz
bcaaaaaaaaaaabacacaaaaoeaeaaaaaaacaaaaoeaeaaaaaa dp3 r0.x, v2, v2
akaaaaaaabaaabacabaaaaaaacaaaaaaaaaaaaaaaaaaaaaa rsq r1.x, r1.x
akaaaaaaaaaaabacaaaaaaaaacaaaaaaaaaaaaaaaaaaaaaa rsq r0.x, r0.x
adaaaaaaaaaaahacaaaaaaaaacaaaaaaacaaaaoeaeaaaaaa mul r0.xyz, r0.x, v2
...
bfaaaaaaafaaaiacacaaaappacaaaaaaaaaaaaaaaaaaaaaa neg r5.w, r2.w
adaaaaaaabaaabacafaaaappacaaaaaaabaaaaaaacaaaaaa mul r1.x, r5.w, r1.x
...
abaaaaaaacaaadacacaaaafeacaaaaaaaiaaaaaaabaaaaaa add r2.xy, r2.xyyy, c8.x
...
bfaaaaaaadaaahacabaaaaoeaeaaaaaaaaaaaaaaaaaaaaaa neg r3.xyz, v1
adaaaaaaacaaahacacaaaakeacaaaaaaabaaaaoeabaaaaaa mul r2.xyz, r2.xyzz, c1
...
ciaaaaaaadaaapacadaaaageacaaaaaaabaaaaaaafbababb tex r3, r3.xyzy, s1 <cube wrap linear point>
bfaaaaaaaeaaahacadaaaaoeaeaaaaaaaaaaaaaaaaaaaaaa neg r4.xyz, v3
bfaaaaaaafaaahacadaaaaoeaeaaaaaaaaaaaaaaaaaaaaaa neg r5.xyz, v3
bcaaaaaaabaaabacaeaaaakeacaaaaaaafaaaakeacaaaaaa dp3 r1.x, r4.xyzz, r5.xyzz
bcaaaaaaaaaaabacacaaaaoeaeaaaaaaacaaaaoeaeaaaaaa dp3 r0.x, v2, v2
