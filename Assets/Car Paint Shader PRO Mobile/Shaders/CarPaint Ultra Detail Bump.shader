...
void main ()
{
  ...
  tmpvar_29 = (tmpvar_28 + (tmpvar_22 * _FlakePower));
  color = tmpvar_29;
  lowp vec4 tmpvar_30;
  tmpvar_30 = ((color + reflTex) + (tmpvar_27 * reflTex));
  color = tmpvar_30;
...
Program "fp" {
// Fragment combos: 6
//   opengl - ALU: 98 to 102, TEX: 4 to 5
//   d3d9 - ALU: 101 to 102, TEX: 4 to 5
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
...
texld r3.xyz, r3, s2
mad_pp r3.xyz, r3, c17.y, c17.zzww
mov r4.y, r2.z
add_pp r0.w, -r0, c16
mov r4.x, v6.z
mov r4.z, v5
...
MUL R0.xy, R0.wyzw, c[16].x;
ADD R0.xy, R0, -c[16].y;
MOV R0.z, c[16];
DP3 R0.z, R0, R0;
ADD R0.w, -R0.z, c[16].y;
MUL R1.xyz, R0.y, R3;
...
mul r2.xyz, r0.y, r1
mad r0.xyz, r0.x, v6, r2
rcp r0.w, r0.w
mad r2.xyz, r0.w, v5, r0
dp3 r0.w, r2, r2
rsq r1.w, r0.w
mul r2.xyz, r1.w, r2
add r0.xyz, -v0, c2
...
dp3_pp r0.x, r4, r0
dp3 r0.w, r2, r3
cmp r1.w, r0, c16.z, c16
max_pp r0.x, r0, c16.z
pow_pp r3, r0.x, c7.x
texldp r4.x, v7, s2
mov_pp r2.w, r3.x
