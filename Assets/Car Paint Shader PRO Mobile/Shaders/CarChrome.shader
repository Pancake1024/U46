...
void main ()
{
  ...
  tmpvar_21.w = 1.0;
  tmpvar_21.x = unity_4LightPosX0.z;
  tmpvar_21.y = unity_4LightPosY0.z;
  tmpvar_21.z = unity_4LightPosZ0.z;
  lightPosition = tmpvar_21;
  highp vec3 tmpvar_22;
  tmpvar_22 = (lightPosition - tmpvar_4).xyz;
  vertexToLightSource = tmpvar_22;
  lowp float tmpvar_23;
  tmpvar_23 = dot (vertexToLightSource, vertexToLightSource);
  highp float tmpvar_24;
  tmpvar_24 = (1.0/((1.0 + (unity_4LightAtten0.z * tmpvar_23))));
  attenuation = tmpvar_24;
  lowp float tmpvar_25;
  tmpvar_25 = max (0.0, dot (tmpvar_1, normalize (vertexToLightSource)));
  highp vec3 tmpvar_26;
  tmpvar_26 = (((attenuation * unity_LightColor[2].xyz) * _Color.xyz) * tmpvar_25);
  diffuseReflection = tmpvar_26;
  tmpvar_2 = (tmpvar_2 + diffuseReflection);
  highp vec4 tmpvar_27;
  tmpvar_27.w = 1.0;
  tmpvar_27.x = unity_4LightPosX0.w;
  tmpvar_27.y = unity_4LightPosY0.w;
  tmpvar_27.z = unity_4LightPosZ0.w;
  lightPosition = tmpvar_27;
  highp vec3 tmpvar_28;
  tmpvar_28 = (lightPosition - tmpvar_4).xyz;
  vertexToLightSource = tmpvar_28;
  lowp float tmpvar_29;
  tmpvar_29 = dot (vertexToLightSource, vertexToLightSource);
  highp float tmpvar_30;
  tmpvar_30 = (1.0/((1.0 + (unity_4LightAtten0.w * tmpvar_29))));
  attenuation = tmpvar_30;
  lowp float tmpvar_31;
  tmpvar_31 = max (0.0, dot (tmpvar_1, normalize (vertexToLightSource)));
  highp vec3 tmpvar_32;
  tmpvar_32 = (((attenuation * unity_LightColor[3].xyz) * _Color.xyz) * tmpvar_31);
  diffuseReflection = tmpvar_32;
  tmpvar_2 = (tmpvar_2 + diffuseReflection);
  gl_Position = (gl_ModelViewProjectionMatrix * _glesVertex);
