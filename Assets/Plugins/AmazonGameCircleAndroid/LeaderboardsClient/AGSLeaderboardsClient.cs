...
public class AGSLeaderboardsClient : MonoBehaviour{
    ...
    [DllImport ("__Internal")]
    private static extern void _AmazonGameCircleRequestScores( string leaderboardId, int scope);

    [DllImport ("__Internal")]
    private static extern void _AmazonGameCircleRequestPercentileRanks( string leaderboardId, int scope);
...
#elif UNITY_IOS
        _AmazonGameCircleRequestScores(leaderboardId, (int)scope);
#else
