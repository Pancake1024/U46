...
public class AGSClient : MonoBehaviour
{
    ...
    [DllImport ("__Internal")]
    private static extern void _AmazonGameCircleShowGameCircleSignIn(bool isAnimated);
#endif
    ...
    static AGSClient()
    {
        CreateNewJavaWrapperObject();
    }

    public static void CreateNewJavaWrapperObject()
    {
#if UNITY_ANDROID && !UNITY_EDITOR
...
#elif UNITY_ANDROID            
        //Debug.Log("###-XXX-### AGSClient - Init - calling JavaObject");
        JavaObject.Call( "init", supportsLeaderboards, supportsAchievements, supportsWhispersync );
        //Debug.Log("###-XXX-### AGSClient - Init - JavaObject called");
#elif UNITY_IOS
    ...
    {
        //Debug.Log("###-XXX-### AGSClient - Client GameCircle - Service is ready");
    ...
    {
        //Debug.Log("###-XXX-### AGSClient - IsServiceReady() - " + IsReady);
        return IsReady;    
    }
...
#elif UNITY_IOS
        // shutdown does not exist for iOS
#endif
    }
    ...
    {
        //Debug.Log("###-XXX-### AGSClient - ServiceNotReady - param: " + param);
        IsReady = false;
...
#elif UNITY_IOS
        _AmazonGameCircleShowGameCircleSignIn(/*isAnimated*/ true);
#endif
    }
